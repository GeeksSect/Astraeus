...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\kruci_000\Desktop\SoC\git\Wall-e\Wall-e\synthesis\MSS_top.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\kruci_000\Desktop\SoC\git\Wall-e\Wall-e\constraint\io\MSS_top.io.pdc"}
set_compile_info \
    -category {"Options"} \
...
compile \
    ...
    -die PA4M1000_N \
    -pkg tq144 \
    -pdc_file {C:\Users\kruci_000\Desktop\SoC\git\Wall-e\Wall-e\constraint\io\MSS_top.io.pdc} \
    -merge_pdc 0
